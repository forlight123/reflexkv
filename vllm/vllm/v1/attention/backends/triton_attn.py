...
class TritonAttentionMetadataBuilder(AttentionMetadataBuilder[TritonAttentionMetadata]):
    ...
    def build(
        ...
        attn_metadata = TritonAttentionMetadata(
            ...
            has_reflex_int4_blocks=common_attn_metadata.has_reflex_int4_blocks,
        )
        return attn_metadata
...
class TritonAttentionImpl(AttentionImpl):
    ...
    def forward(
        ...
        if not has_reflex_int4_blocks:
            ...
            raise RuntimeError(
                "ReFlexKV block table contains INT4 entries but no "
                "reflex_int4_kv_cache is bound for "
                f"layer={getattr(layer, 'layer_name', '<unknown>')}, "
                f"layer_kv_cache_dtype={getattr(layer, 'kv_cache_dtype', None)}, "
                f"impl_kv_cache_dtype={self.kv_cache_dtype}."
            )
        ...
        unified_attention(
            ...
            reflex_int4_kv_cache=reflex_int4_cache,
        )
