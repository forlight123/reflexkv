...
class KVConnectorBase_V1(ABC):
    ...
    def register_reflex_int4_kv_caches(
        ...
        """
        Initialize with ReFlexKV's packed INT4 sidecar KV caches.
        Connectors that materialize precision-lowered remote KV pages can
        override this without changing the default KV transfer API.
        """
        return
